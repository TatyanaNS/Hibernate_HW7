    ...
    <div class="row">
        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group me-2" role="group" aria-label="Second group">
                <a href="/customers/new" type="button" class="btn add">
            ...
            <c:forEach var="customer" items="${customers}">
                <tr>
                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="Second group">
                                <a href="/customers/<c:out value = '${customer.id}'/>" alt="?????????????" type="button" class="btn edit_btn">
                                ...
                                <a href="/customers?deleteId=<c:out value = '${customer.id}'/>" alt="???????" type="button" class="btn del_btn">
